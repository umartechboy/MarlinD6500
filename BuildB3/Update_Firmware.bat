...
esptool.exe --chip esp32s3 --baud 460800 write_flash 0x0 bootloader.bin 0x8000 partitions.bin 0x10000 firmware.bin 0x1E0000 firmware.bin 0x3B0000 spiffs.bin
