...
KeypadCalibStep::KeypadCalibStep(MenuHost* host):MenuStep(host)
{
...
void KeypadCalibStep::Paint(BufferedDisplay* g){            
...
void KeypadCalibStep::LoadComplete(){    
    Preferences prefs;
    prefs.begin(NAMESPACE, true);
    String defV = "";
