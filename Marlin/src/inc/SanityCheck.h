 ...
 */
  ...
  + (ENABLED(IS_LEGACY_TFT) && COUNT_ENABLED(TFT_128x128_SPI, TFT_320x240, TFT_320x240_SPI, TFT_480x320, TFT_480x320_SPI)) \
...
#if MANY(TFT_RES_128x128, TFT_RES_320x240, TFT_RES_480x272, TFT_RES_480x320, TFT_RES_1024x600)
